...
var defaultConfig = {
  fromEmail: "noreply@daikerjohn.cc",
  subjectPrefix: "",
  emailBucket: "emailbucket-daikerjohncc",
  emailKeyPrefix: "daikerjohncc/",
  allowPlusSign: true,
  forwardMapping: {
    "@daikerjohn.cc": [
      "johndaiker@hotmail.com"
    ]
  }
};
...
export const handler = function(event, context, callback, overrides) {
  ...
  var data = {
    ...
    s3: overrides && overrides.s3 ? overrides.s3 : new S3Client(
      defaultConfig.emailBucketRegion ? {region: defaultConfig.emailBucketRegion} : {}
    )
  };
